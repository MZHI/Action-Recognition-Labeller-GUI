...
#  is_processed=0
  ...
  echo "main.py --mode single --video_path \"${VIDEOSPATH}/${filename}\" --classes_csv classes_tng.csv --out_csv_root labels"
  python main.py --mode single --video_path "${VIDEOSPATH}/${filename}" --classes_csv classes_tng.csv --out_csv_root labels
