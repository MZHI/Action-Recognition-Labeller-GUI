...
def decode_video(video_path):
    ...
    video_path_scr = "\ ".join(video_path_parts)
    
    video_name = Path(video_path).stem
    video_name_scr = "\ ".join(video_name.split(" "))

    new_folder = "/".join(['data', video_name])
    new_folder_scr = "/".join(['data', video_name_scr])

    # print(f"video_path_parts: {video_path_parts}")
    # print(f"video_path: {video_path}")
    # print(f"video_path_scr: {video_path_scr}")
    # print(f"video_name: {video_name}")
    # print(f"video_name_scr: {video_name_scr}")
    # print(f"new_folder: {new_folder}")
    # print(f"new_folder_scr: {new_folder_scr}")
